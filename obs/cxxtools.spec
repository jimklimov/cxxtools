...
# PATCH-FIX-UPSTREAM
#Patch1:         0001-fix-memory-leak-in-deserializer.patch
# PATCH-FIX-UPSTREAM
#Patch2:         0002-add-missing-guard-to-pool.h.patch
# PATCH-FIX-BIOS: backport newest Mime API to cxxtools to avoid leak of the old one
#Patch3:         0003-backport-mime.patch
BuildRequires:  gcc-c++
...
%package demo
Summary:        Cxxtools Demo Files
Group:          Development/Libraries/C and C++

%description demo
Demonstration files and examples for cxxtools
